...
class Extended_PreStart_EventHandlers
{
	class ghostb_US_DCU_lite
	{
		init="call compile preprocessFileLineNumbers '\z\ghostb\addons\US_DCU_lite\XEH_preStart.sqf'";
	};
};
class Extended_PreInit_EventHandlers
{
	class ghostb_US_DCU_lite
	{
		init="call compile preprocessFileLineNumbers '\z\ghostb\addons\US_DCU_lite\XEH_preInit.sqf'";
	};
};
class Extended_PostInit_EventHandlers
{
	class ghostb_US_DCU_lite
	{
		init="call compile preprocessFileLineNumbers '\z\ghostb\addons\US_DCU_lite\XEH_postInit.sqf'";
	};
};
class CfgWeapons
{

    ...
    class CfgWeapons {
        class Crye_AVS_1 {
            ...
            class avs_base {
                ...
                // class AOR1 {
                //     label = "AOR";
                //     image = "z\aceax\addons\gearinfo\data\camo\aor.paa";
                // };
            };
        };
        class Crye_AVS_1_1 {
            options[] = { "avs_base"};
            label = "AVS Assaulter #2";
            class avs_base {
                label = "avs_base";
                alwaysSelectable = 1;
                values[] = {

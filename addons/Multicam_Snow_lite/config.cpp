...
class Extended_PreStart_EventHandlers
{
	class ghostb_Multicam_Snow_lite
	{
		init="call compile preprocessFileLineNumbers '\z\ghostb\addons\Multicam_Snow_lite\XEH_preStart.sqf'";
	};
};
class Extended_PreInit_EventHandlers
{
	class ghostb_Multicam_Snow_lite
	{
		init="call compile preprocessFileLineNumbers '\z\ghostb\addons\Multicam_Snow_lite\XEH_preInit.sqf'";
	};
};
class Extended_PostInit_EventHandlers
{
	class ghostb_Multicam_Snow_lite
	{
		init="call compile preprocessFileLineNumbers '\z\ghostb\addons\Multicam_Snow_lite\XEH_postInit.sqf'";
	};
};
class CfgWeapons
{

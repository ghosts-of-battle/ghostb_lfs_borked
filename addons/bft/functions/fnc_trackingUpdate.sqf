 ...
 *
 * Example:
 * call ghostb_bft_fnc_trackingUpdate
 *
 * Public: No
 */

if ((isNil "ghostb_unit") && (!alive ghostb_unit)) exitWith {};
...
if (GVAR(requireItemGPS) && !([ghostb_unit] call FUNC(hasGPSDevice))) exitWith {};
